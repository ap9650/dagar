...
Eleven of the thirty six messages sent to the tutor were about the screen
...
| D27 | The tutor is evaluated against real learner messages | A 50-case golden set gates every prompt change. Real traffic sets the categories, because 11 of 36 messages were learners lost in the interface |
